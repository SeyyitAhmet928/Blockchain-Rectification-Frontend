  ...
  return (
    ...
    >
      ...
      >
        ...
        <div
          className="rounded-lg px-8 py-2 cursor-pointer hidden sm:block lg:mr-[17em] md:mr-[24em]"
          style={{
            background:
        ...
        <div className="hidden lg:flex ml-[17em]">
          ...
          <div className="border border-purple-500 px-7 w-[3.8em]  rounded-md flex flex-col items-center mx-1 cursor-pointer">
            ...
            <span className="text-[0.6rem] text-center">Link Manager</span>
          </div>
          <div className="border border-purple-500 px-7 w-[3.8em]  rounded-md flex flex-col items-center mx-1 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="text-[0.6rem] text-center">Earning Report</span>
          </div>
          <div className="border border-purple-500 px-7 w-[3.8em]  rounded-md flex flex-col justify-center items-center mx-1 cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
            ...
            <span className="text-[0.6rem] text-center">Dashboard</span>
          </div>
        </div>
        <div
      ...
      >
        <thead className="bg-[#ffffff1a] h-14 text-[3.428vw] md:text-[1.3em] px-2">
          <tr>
            ...
            <th style={{ fontWeight: "100", width: "10%" }}>EARNINGS TOTAL</th>
            <th></th>
          </tr>
        </thead>
        <tbody className="px-2">
          <tr className="bg-[#ffffff1a] h-14 mt-2 text-center self-center text-[3em] md:text-[1.8em] xl:text-[1em] my-1">
            <td>
              <span>12/2/24</span>
            </td>
            <td>
        ...
        <div className="w-[16em] h-[13em] bg-[#692bd6] text-white rounded-lg p-3">
          ...
          <div className="flex justify-center">
            <div className="flex flex-col">
              ...
              <p className="p-1 ml-4 text-[1em] opacity-50">Today</p>
            </div>
            ...
            <div className="flex flex-col">
              ...
              <p className="ml-4 text-[1em] opacity-50">Today(Paid)</p>
            </div>
          </div>
        </div>
