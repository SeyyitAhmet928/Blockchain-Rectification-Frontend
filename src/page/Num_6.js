    ...
    >
      ...
      <div className="flex p-[1em] py-[1.75em]">
        ...
        <div className="ml-auto self-center">
          <select
            className="bg-inherit text-white rounded-lg border border-sky-500 w-[7em] py-[0.5em]"
      ...
      >
        ...
        <tbody>
          <tr
            className="bg-[#ffffff1a] h-14 mt-2 text-center self-center text-[2.5em] md:text-[2em] xl:text-[1.3em]"
          >
            <td>
              <span>1</span>
            </td>
